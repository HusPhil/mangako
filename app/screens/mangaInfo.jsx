  ...
  return (
    <View className="h-full w-full bg-primary">
          ...
          <View>
            ...
            <View className="flex-row w-full px-2 absolute bottom-3 max-h-[185px]">
              <MangaCard
                ...
                disabled
              >
                <Text className="text-white text-xs text-center font-pregular mt-1">{details && !isLoading ? details.status.toUpperCase() : "Loading"}</Text>
              </MangaCard>
      ...
      >
        ...
        <View className="mx-2">
          <HorizontalRule displayText="Chapter list" otherStyles={"mx-1"} />
